...
##########################################################################################
# Shows how to create a package and publish that direclty with msdeploy.exe
##########################################################################################
...
$deployArgs += '-dest:autoComputerName="https://waws-prod-ch1-001.publish.azurewebsites.windows.net:443/msdeploy.axd?site=imgopt",Username="$imgopt",Password="HrbeLx82JewesNmbhsHcKrfuljkeZ6CmiQbiQfk0NYv6kBNevrkR7Bbkv6gx",AuthType="basic"'
$deployArgs += '-setParamFile:"C:\Users\sayedha\AppData\Local\Temp\AzureJobs.SiteExtension.Web_zip\SetParameters.xml'
$deployArgs += '-setParam:Name=foo'
